...
const WasherDashboard = () => {
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      const dashboardResponse = await axios.get(`https://zuci-sbackend-8.onrender.com/api/washer/${user.id}/dashboard`);
      const dashboardData = dashboardResponse.data;
      
      // Fetch assigned leads for display
      const leadsResponse = await axios.get(`https://zuci-sbackend-8.onrender.com/api/washer/${user.id}/assigned-leads`);
